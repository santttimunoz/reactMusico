        ...
        <div className='container'>
            <div className='row'>
                <div className='col-12 col-md-6'>
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/musicossmm.appspot.com/o/jimmy2.webp?alt=media&token=e831b6a7-de27-489a-9716-38ad40d919f2" alt="foto" className='img-fluid w-100'/>
                </div>
                <div className='col-12 col-md-3'>
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/musicossmm.appspot.com/o/jimmy.webp?alt=media&token=a62c756d-637f-4b72-96d3-3f9d0b754f9c" alt="foto" className='img-fluid w-100' />
                </div>
                <div className="col-12 col-md-3">
